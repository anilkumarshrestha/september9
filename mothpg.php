...
<html lang="en">
<head>
    <title>September9 | For Mother</title>
...
<body>
  ...
  <div class="bs-example">
  	<ul class="nav nav-pills">
          <li ><a href="/">Home</a></li>
          <li class="active"><a href="mothpg.php">For Mother</a></li>
    ...
    <div class="container-fluid bpadding">
      ...
      ?>
        <div class="col-xs-3">
          <a href="product_detail.php?cat=M&id=<?php echo $row["id"]; ?>">
      	    <img src="<?php echo $row["image"]; ?>" class="img-fluid" alt="Responsive image">
            <p class="prod-title"><strong><?php echo $row["name"];?></strong></p>

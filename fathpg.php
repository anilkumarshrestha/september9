...
<html lang="en">
<head>
    <title>September9 | For Father</title>
...
<body>
  ...
  <div class="bs-example">
  	<ul class="nav nav-pills">
          ...
          <li class="active"><a href="fathpg.php">For Father</a></li>
          <li><a href="girlpg.php">For Girls</a></li>
          <li><a href="boypg.php">For Boys</a></li>
  	</ul>
  </div>
    ...
    <div class="container-fluid bpadding">
      <?php
      $stmt = $pdo->prepare("SELECT * FROM products WHERE cat_id = 2");
      if (!$stmt->execute()) {
      ...
      ?>
                ...
                <div class="col-sm-3" style="mergin-left:30%;">
                  <a href="product_detail.php?cat=F&id=<?php echo $row["id"]; ?>">
